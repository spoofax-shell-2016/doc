...
has been evaluated, the yielded result is bound to an
automatically created identifier, such that it can be easily reused in future
expressions.
...
oftentimes not in the syntax of the language the REPL belongs to and are highly
diverse between REPL implementations. A notable example of a REPL offering such
