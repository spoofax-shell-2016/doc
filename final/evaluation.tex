...
The largest issue that occurred during the development is the fact that Spoofax
...
a REPL was no longer present. To resolve this, much of the effort went to
cooperating with DynSem's developer to implement this missing functionality.
While this resulted in a significant delay of around two weeks, this time was
thus not wasted because DynSem benefited from this effort.\\
