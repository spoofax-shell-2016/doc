...
The product is currently awaiting its acceptance test. Recommendations to further
enhance it have been made to the client. For example, more interpreter backends
can be provided and the Eclipse frontend can integrate more with Spoofax Eclipse.
