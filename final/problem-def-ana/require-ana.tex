...
% FIXME: what to do with this one? We don't generate a REPL: it is always there.
...
% FIXME: what to do with the explanation here? Personally I think it should just
% say that multiline input should be available.
...
% TODO: expand and say that analysis/interpreter errors should be printed, as
% opposed to only interpreter errors?
...
% FIXME: if we remove the second design goal, this section needs to updated
% accordingly.
