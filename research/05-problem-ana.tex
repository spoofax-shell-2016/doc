...
To create a REPL that works with any language defined in Spoofax,
some Spoofax concepts have to be carefully considered. Every language
can have many different language constructs. The REPL for Spoofax,
however, should not be constrained to any particular language
constructs like classes, but should rather operate on any defined
language. For this reason the implementation and particularly the
interaction with the user needs to be carefully considered. This
sections lists some of the problems that are expected to arise from
this.
